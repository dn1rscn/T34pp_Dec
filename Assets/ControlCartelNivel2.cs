...
public class ControlCartelNivel2 : MonoBehaviour
{
	...
	public void carteles()
	{
		...
		case 1:					//respuesta correcta en cartel1
			...
			cdg.Cartel1.GetComponent<Text> ().text=cdg.Palabras[cdg.PicAleat];
			text = cdg.Cartel1.GetComponent<Text> ().text;
			cdg.Cartel1.GetComponent<Text> ().text = languageDictionary.stringList [text];
			cartel2();
			cartel3();
			break;
		...
		case 2:					//respuesta correcta en cartel2
			...
			cdg.Cartel2.GetComponent<Text> ().text=cdg.Palabras[cdg.PicAleat];
			text = cdg.Cartel2.GetComponent<Text> ().text;
			cdg.Cartel2.GetComponent<Text> ().text = languageDictionary.stringList [text];
			cartel1 ();
			cartel3 ();
			break;
		...
		case 3:					//respuesta correcta en carte3
			...
			cdg.Cartel3.GetComponent<Text> ().text=cdg.Palabras[cdg.PicAleat];
			text = cdg.Cartel3.GetComponent<Text> ().text;
			cdg.Cartel3.GetComponent<Text> ().text = languageDictionary.stringList [text];
			cartel1 ();
			cartel2 ();
			break;
	...
	void cartel1 ()
	{
		cdg.cart1 = Random.Range (0, cdg.Palabras.Length);
		...
		cdg.Cartel1.GetComponent<Text> ().text=cdg.Palabras[cdg.cart1];
		text = cdg.Cartel1.GetComponent<Text> ().text;
		cdg.Cartel1.GetComponent<Text> ().text = languageDictionary.stringList [text];
	}
	void cartel2 ()
	{
		cdg.cart2 = Random.Range (0, cdg.Palabras.Length);
		...
		cdg.Cartel2.GetComponent<Text> ().text=cdg.Palabras[cdg.cart2];
		text = cdg.Cartel2.GetComponent<Text> ().text;
		cdg.Cartel2.GetComponent<Text> ().text = languageDictionary.stringList [text];
	}
	void cartel3 ()
	{	
		cdg.cart3 = Random.Range (0, cdg.Palabras.Length);
		...
		cdg.Cartel3.GetComponent<Text> ().text=cdg.Palabras[cdg.cart3];
		text = cdg.Cartel3.GetComponent<Text> ().text;
		cdg.Cartel3.GetComponent<Text> ().text = languageDictionary.stringList [text];
	}
}
